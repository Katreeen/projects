...
$APPLICATION->SetTitle("Select a section");
?>
<div class="common">
	<div class="container">
	...
	array(
		...
		"SHOW_MAX_QUANTITY" => "N",
		"MESS_BTN_BUY" => "Купить",
		"MESS_BTN_ADD_TO_BASKET" => "Add to Request",
		...
		"MESS_DESCRIPTION_TAB" => "General information",
		"MESS_PROPERTIES_TAB" => "Chemical and physical properties",
		"MESS_COMMENTS_TAB" => "Information about hazards and transportation",
