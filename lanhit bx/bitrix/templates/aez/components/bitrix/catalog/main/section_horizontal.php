		...
		<div class="row">
			...
			<div class="col-lg-9">
				<div class="common__top">
					<div class="common__title title"><? $APPLICATION->AddBufferContent('h1'); ?></div>
					<!-- <div class="common__filter-btn">Фильтрация</div> -->
				</div>
				<?$APPLICATION->ShowViewContent('section_info');?>
				...
				<div class="common__filter-btn js-show-filter">Фильтрация</div>

				<div class="filter-modal" data-type="filter">
					...
					<div class="modal-title">Фильтрация</div>
					</div>
				</div>
