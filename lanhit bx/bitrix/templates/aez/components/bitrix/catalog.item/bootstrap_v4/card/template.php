		...
		<div class="offer-card__content">
			...
			<div class="offer-card__top">
				...
				<!-- <div class="offer-card__more">
					<span>Показать предложения</span><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M13.3335 5.9987L8.00016 11.332L2.66683 5.9987" stroke="#2F80ED" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
					</svg>
				</div> -->
			...
			switch ($blockName)
			{
						...
						if (!$haveOffers)
						{
							if ($actualItem['CAN_BUY'])
							{
								...
								<div class="product-item-button-container" id="<?=$itemIds['BASKET_ACTIONS']?>">
									<a class="offer-card__more-detail" href="<?=$item['DETAIL_PAGE_URL']?>">
										<?=$arParams['MESS_BTN_DETAIL']?>
									</a>
									
									<button class="offer-card__more" id="<?=$itemIds['BUY_LINK']?>" style="display:none"
				...
				case 'sku':
					if ($arParams['PRODUCT_DISPLAY_MODE'] === 'Y' && $haveOffers && !empty($item['OFFERS_PROP']))
					{
						...
						<div class="product-item-info-container table-detail" id="<?=$itemIds['PROP_DIV']?>">
							<div class="table-detail__head">
									<div class="table-detail__column table-detail__column--s">
											<div class="table-detail__text table-detail__text--bold">Номер товара</div>
									</div>
									<div class="table-detail__column table-detail__column--m">
											<div class="table-detail__text table-detail__text--bold">Размер </div>
									</div>
									<div class="table-detail__column table-detail__column--l">
											<div class="table-detail__text table-detail__text--bold">Ценовое предложение</div>
									</div>
							</div>
