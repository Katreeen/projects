...
<div class="smart-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "smart-filter-horizontal"?>">
	<div class="smart-filter-section">
		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smart-filter-form common__filter-form">
			<div class="common__filter-close"></div>
			<div class="common__filter-title">Фильтрация</div>
			...
			<?endforeach;?>
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					<div class="smart-filter-parameters-box bx-active">
							...
							<div class="common__filter-name"><?=$arItem["NAME"]?></div>
						...
						<div class="common__filter-list smart-filter-block" data-role="bx_filter_block">
							<div class="smart-filter-parameters-box-container">
							<?
