...
<div class="personal-card">
	<div class="personal-card__wrap">
		<?$photo = CFile::ResizeImageGet($arUser['PERSONAL_PHOTO'], array('width'=>130, 'height'=>130), BX_RESIZE_IMAGE_PROPORTIONAL, true);?>
			<div class="personal-card__preview"><img src="<?=$photo['src']?>" alt=""></div>
			...
			<div class="personal-card__content">
					<div class="personal-card__top">
							<div class="title title--second"><?=$arUser['LAST_NAME']?> <?=$arUser['NAME']?></div><a class="personal-card__link" href="<?$USER->Logout();?>">Выйти из аккаунта</a><br>
							<a class="personal-card__link js-show-modal" href="#" data-type="pass">Редактировать</a>
					</div>
					<div class="personal-card__details">
							<div class="personal-card__part">
									<div class="personal-card__detail">
											<div class="personal-card__name">Дата регистрации:</div>
											<div class="personal-card__desc"><?=$arUser['DATE_REGISTER']?></div>
									</div>
									<div class="personal-card__detail">
											<div class="personal-card__name">Телефон:</div>
											<div class="personal-card__desc"><?=$arUser['PERSONAL_PHONE']?></div>
									</div>
									<div class="personal-card__detail">
											<div class="personal-card__name">Компания:</div>
											<div class="personal-card__desc"><?=$arUser['WORK_COMPANY']?></div>
									</div>
							</div>
							<div class="personal-card__part">
									<div class="personal-card__detail personal-card__detail--mobile">
											<div class="personal-card__name">Пароль:</div>
											<div class="personal-card__desc">*********</div>
									</div>
									<div class="personal-card__detail personal-card__detail--mobile">
											<div class="personal-card__name">Email:</div>
											<div class="personal-card__desc"><?=$arUser['EMAIL']?></div>
									</div>
							</div>
					</div>
			</div>
...
<div class="modal" data-type="pass">
	<div class="modal__bg"></div>
	<div class="modal__cover">
			<div class="modal__inner">
					<button class="modal__close js-modal-close"></button>
					<div class="title title--second">Изменить пароль</div>
					<?if($arResult["SHOW_SMS_FIELD"] == true):?>
...
<div class="modal" data-type="email">
	<div class="modal__bg"></div>
	<div class="modal__cover">
			<div class="modal__inner">
					<button class="modal__close js-modal-close"></button>
					<div class="title title--second">Изменить email</div>
					<form class="modal__form" action="" method="">
							<div class="modal__place">
									<div class="input-place">
											<label class="input-place__label">Старый email:</label>
											<input class="input-place__input" type="text" name="old_password" placeholder="Введите старый email">
									</div>
							</div>
							<div class="modal__place">
									<div class="input-place">
											<label class="input-place__label">Новый email:</label>
											<input class="input-place__input" type="text" name="new_password" placeholder="Введите новый email">
									</div>
							</div>
							<div class="modal__submit">
									<button class="button button--width">Изменить пароль</button>
							</div>
					</form>
			</div>
	</div>
