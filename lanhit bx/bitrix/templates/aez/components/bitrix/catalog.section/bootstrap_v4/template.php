...
?>
	...
	if ($showTopPager)
	{
		?>
			...
			<div class="top-pagen" data-pagination-num="<?=$navParams['NavNum']?>">
				<!-- pagination-container -->
				<?=$arResult['NAV_STRING']?>
				<!-- pagination-container -->
			</div>
	...
	{
		?>
		<div class="common__content-text"><?=$arResult['DESCRIPTION']?></div>
		<?
	}*/
	//endregion
	?>

		<div class="common__list" data-entity="<?=$containerName?>">
			<!-- items-container -->
			<?
		...
		if ($showBottomPager)
		{
			?>
				...
				<div class="bottom-pagen" data-pagination-num="<?=$navParams['NavNum']?>">
					<!-- pagination-container -->
					<?=$arResult['NAV_STRING']?>
					<!-- pagination-container -->
				</div>
...
<?$this->SetViewTarget('section_info');?>
<div class="section-info">
	<!-- <img class="section-info__image" src="<?//=$arResult['PICTURE']['SRC']?>" alt=""> -->
