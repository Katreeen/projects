...
?>
		...
		{
		?><ul class="catalog__list <? echo $arCurView['LIST']; ?>"><?
				...
				case 'TILE':
					foreach ($arResult['SECTIONS'] as &$arSection)
					{
						...
						if (false === $arSection['PICTURE'])
							...
							?>
							<li id="<? echo $this->GetEditAreaId($arSection['ID']); ?>"  class="catalog__item catalog-section-list-item">
								<div class="catalog-section-list-tile-img-container">
									<a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="catalog-img">
								...
								{
									?>
										<div class="catalog-section-list-item-inner catalog-info">
												<span class="catalog-title"><? echo $arSection['NAME']; ?></span>
												<a class="catalog-section-list-item-link catalog-btn button" href="<? echo $arSection['SECTION_PAGE_URL']; ?>"> В магазин </a>
